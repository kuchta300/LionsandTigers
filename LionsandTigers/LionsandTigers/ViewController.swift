...
//  LionsandTigers
//
//  Created by David Kuchta on 9/28/14.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        println("My Tiger's name is: \(myTiger.name), it's age is \(myTiger.age), it's breed is \(myTiger.breed), and the image is \(myTiger.image)")
        ...
        secondTiger.chuffANumberOfTimes(4,isLoud:true)
